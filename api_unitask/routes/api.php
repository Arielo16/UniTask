...
Route::prefix('goods')->group(function () {
    ...
    Route::get('get/{goodID}', [GoodController::class, 'show']);
    Route::put('put/{goodID}', [GoodController::class, 'update']);
    Route::delete('delete/{goodID}', [GoodController::class, 'destroy']);
});
...
Route::prefix('categories')->group(function () {
    ...
    Route::get('get/{categoryID}', [CategoryController::class, 'show']); // Obtener una categoría específica
    Route::put('put/{categoryID}', [CategoryController::class, 'update']); // Actualizar una categoría
    Route::delete('delete/{categoryID}', [CategoryController::class, 'destroy']); // Eliminar una categoría
});
...
Route::prefix('rooms')->group(function () {
    ...
    Route::get('get/{roomID}/{buildingID}', [RoomController::class, 'show']); // Obtener un salón específico
    Route::put('put/{roomID}/{buildingID}', [RoomController::class, 'update']); // Actualizar un salón
    Route::delete('delete/{roomID}/{buildingID}', [RoomController::class, 'destroy']); // Eliminar un salón
});
